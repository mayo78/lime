...
class Gamepad
{
	...
	public var onAxisMovePrecise = new Event<GamepadAxis->Float->Float->Void>();
	public var onButtonDownPrecise = new Event<GamepadButton->Float->Void>();
	public var onButtonUpPrecise = new Event<GamepadButton->Float->Void>();
